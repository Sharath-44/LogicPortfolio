...
const ProfileCard = () => {
  return (
    ...
    >
      <div className="w-full max-w-7xl p-8 bg-zinc-800 text-white flex flex-col md:flex-row items-center md:items-start md:space-x-12 rounded-lg shadow-lg my-8"> {/* Added margin y-axis */}
        ...
        <div className="w-full md:w-3/4 mt-8 md:mt-0">
          ...
          <h1 className="text-5xl md:text-7xl font-bold mt-2">Sharath M S</h1>
