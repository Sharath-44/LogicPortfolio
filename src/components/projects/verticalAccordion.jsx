...
const VerticalAccordion = () => {
  ...
  return (
    <section className="p-4 bg-zinc-900">
      <h1 className="text-3xl font-bold text-white text-center mb-4">My Projects</h1> {/* Big title added here */}
...
const Panel = ({ open, setOpen, id, Icon, title, imgSrc, description }) => {
  ...
  return (
    <>
      <button
        className="bg-zinc-700 hover:bg-slate-50 transition-colors p-3 border-r-[1px] border-b-[1px] border-slate-200 flex flex-row-reverse lg:flex-col justify-end items-center gap-4 relative group"
        onClick={() => setOpen(id)}
      >
        <span
          style={{
